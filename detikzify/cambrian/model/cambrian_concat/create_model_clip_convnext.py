...
detikzify_model.save_pretrained(save_directory="detikzify-cambrian-concat-1B-clip_siglip_dino_convnext-XXL")
detikzify_processor.save_pretrained(save_directory="detikzify-cambrian-concat-1B-clip_siglip_dino_convnext-XXL")
config.save_pretrained(save_directory="detikzify-cambrian-concat-1B-clip_siglip_dino_convnext-XXL")
tokenizer.save_pretrained(save_directory="detikzify-cambrian-concat-1B-clip_siglip_dino_convnext-XXL")
