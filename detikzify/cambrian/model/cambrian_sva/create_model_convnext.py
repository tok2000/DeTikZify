...
vision_encoders = ["google/siglip-so400m-patch14-384", "facebook/dinov2-base", "CLIP-convnext-XXL"]
...
detikzify_model.save_pretrained(save_directory="detikzify-cambrian-1B-siglip_dino_convnext-XXL")
detikzify_processor.save_pretrained(save_directory="detikzify-cambrian-1B-siglip_dino_convnext-XXL")
config.save_pretrained(save_directory="detikzify-cambrian-1B-siglip_dino_convnext-XXL")
tokenizer.save_pretrained(save_directory="detikzify-cambrian-1B-siglip_dino_convnext-XXL")
