...
class SiglipVisionTower(ClipVisionTower):
    ...
    def load_model(self, device_map=None):
        ...
        self._hidden_size = self.vision_tower.embed_dim # hidden size of the vision model
        self._image_size = self.vision_tower.patch_embed.img_size[0] # image size of the vision model
        self._patch_size = self.vision_tower.patch_embed.patch_size[0] # patch size of the vision model
        self.image_processor = processor # image processor of the vision model
