...
from detikzify.model.cambrian.utils import IS_XLA_AVAILABLE
...
class ClipVisionTower(BaseVisionTower):
    def __init__(self, vision_tower_name, args, delay_load=False):
        ...
        base_model_name, interp = extract_interp(vision_tower_name) # initialize the base model name and interpolation size
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name) # load the image processor
        self.vision_tower = CLIPVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map) # load the vision model
